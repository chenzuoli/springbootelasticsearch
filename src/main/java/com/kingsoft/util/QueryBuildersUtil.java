...
public abstract class QueryBuildersUtil {
     ...
     * @param values The terms
     */
    public static TermsQueryBuilderUtil termsQuery(String name, Collection<?> values) {
        return new TermsQueryBuilderUtil(name, values);
    }
